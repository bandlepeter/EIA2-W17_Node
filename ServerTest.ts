...
namespace ServerTest {
    ...
    function handleRequest(_request: Http.IncomingMessage, _response: Http.ServerResponse): void {
        ...
        // ?//bei Google Suche zeigt GitHub Seite Prof
        let query: AssocStringString = Url.parse(_request.url, true).query;//was macht diese Zeile?
        //übersetzt die URL in String
        //Duden: as­so­zi­ie­ren - sich zusammenschließen, vereinigen; sich anschließen
        //Daten werden als String in ein Stringarray abgelegt. Es ist also kein Array welches mit Zahlen aufgerufen wird
        // ?
        for (let key in query)//wie arbeitet diese Schleife?
            console.log(key + ": " + query[key]);
            //sie gibt die einzelnen Daten aus dem Stringarray aus
